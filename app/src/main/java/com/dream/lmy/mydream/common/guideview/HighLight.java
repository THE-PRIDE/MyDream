package com.dream.lmy.mydream.common.guideview;
...
import com.dream.lmy.mydream.common.guideview.util.ViewUtils;
...
public class HighLight implements HighLightInterface, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private HighLightView mHightLightView;
...
//        return mHightLightView = (HightLightView) ((Activity) mContext).findViewById(R.id.high_light_view);
    ...
    public HighLight show() {
        ...
        HighLightView hightLightView = new HighLightView(mContext, this, maskColor, mViewRects, isNext);
...
//        hightLightView.setId(R.id.high_light_view);
    ...
    private static final class ListenersHandler extends Handler {
        ...
        private HighLightView hightLightView;
