...
import com.dream.lmy.mydream.common.guideview.interfaces.HighLightInterface;
import com.dream.lmy.mydream.common.guideview.position.OnBottomPosCallback;
import com.dream.lmy.mydream.common.guideview.position.OnLeftPosCallback;
import com.dream.lmy.mydream.common.guideview.position.OnRightPosCallback;
import com.dream.lmy.mydream.common.guideview.position.OnTopPosCallback;
import com.dream.lmy.mydream.common.guideview.shape.BaseLightShape;
import com.dream.lmy.mydream.common.guideview.shape.CircleLightShape;
import com.dream.lmy.mydream.common.guideview.shape.OvalLightShape;
import com.dream.lmy.mydream.common.guideview.shape.RectLightShape;
import com.dream.lmy.mydream.common.guideview.view.HighLightView;

public class MyGuideUtils extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guide_view_layout);
...
//        if(hasFocus) mHightLight.show();
    ...
    public void showTipView(View view) {
        mHightLight = new HighLight(MyGuideUtils.this)//
    ...
    public void showNextTipViewOnCreated() {
        mHightLight = new HighLight(MyGuideUtils.this)//
                ...
                .setClickCallback(new HighLight.OnClickCallback() {
                    @Override
                    public void onClick() {
                        Toast.makeText(MyGuideUtils.this, "clicked and show next tip view by yourself", Toast.LENGTH_SHORT).show();
                        mHightLight.next();
                    }
                });
    }
    ...
    public void showKnownTipView(View view) {
        mHightLight = new HighLight(MyGuideUtils.this)//
                ...
                .setClickCallback(new HighLight.OnClickCallback() {
                    @Override
                    public void onClick() {
                        Toast.makeText(MyGuideUtils.this, "clicked and remove HightLight view by yourself", Toast.LENGTH_SHORT).show();
                        remove(null);
                    }
                })
                .anchor(findViewById(R.id.id_container))//如果是Activity上增加引导层，不需要设置anchor
...
//                })
                ...
                .setOnRemoveCallback(new HighLightInterface.OnRemoveCallback() {//监听移除回调
                    ...
                    public void onRemove() {
                        Toast.makeText(MyGuideUtils.this, "The HightLight view has been removed", Toast.LENGTH_SHORT).show();

                    }
                })
                .setOnShowCallback(new HighLightInterface.OnShowCallback() {//监听显示回调
                    @Override
                    public void onShow(HighLightView hightLightView) {
                        Toast.makeText(MyGuideUtils.this, "The HightLight view has been shown", Toast.LENGTH_SHORT).show();
                    }
                }).setOnNextCallback(new HighLightInterface.OnNextCallback() {
                    @Override
                    public void onNext(HighLightView hightLightView, View targetView, View tipView) {
                        // targetView 目标按钮 tipView添加的提示布局 可以直接找到'我知道了'按钮添加监听事件等处理
                        Toast.makeText(MyGuideUtils.this, "The HightLight show next TipView，targetViewID:" + (targetView == null ? null : targetView.getId()) + ",tipViewID:" + (tipView == null ? null : tipView.getId()), Toast.LENGTH_SHORT).show();
                    }
                });
        mHightLight.show();
    }
...
//                .addHighLight(R.id.id_btn_important, R.view_float_layout.info_up,
...
//                            }
//                        })//
//                .addHighLight(R.id.id_btn_amazing, R.view_float_layout.info_down, new HighLight.OnPosCallback()
//                {
//                    /**
...
//
//                });
//        .addHighLight(R.id.id_btn_important_right,R.view_float_layout.info_gravity_right_up, new HighLight.OnPosCallback(){
//
//
//            @Override
//            public void getPos(float rightMargin, float bottomMargin, RectF rectF, HighLight.MarginInfo marginInfo) {
...
//            }
//        })
//        .addHighLight(R.id.id_btn_whoami, R.view_float_layout.info_gravity_left_down, new HighLight.OnPosCallback() {
//
//
//            @Override
//            public void getPos(float rightMargin, float bottomMargin, RectF rectF, HighLight.MarginInfo marginInfo) {
...
//        mHightLight = new HighLight(MainActivity.this)//
//                .anchor(findViewById(R.id.id_container))//如果是Activity上增加引导层，不需要设置anchor
//                .addHighLight(R.id.btn_rightLight,R.view_float_layout.info_left, new OnLeftPosCallback(10),new RectLightShape())
//                .addHighLight(R.id.btn_light,R.view_float_layout.info_right,new OnRightPosCallback(),new CircleLightShape())
//                .addHighLight(R.id.btn_bottomLight,R.view_float_layout.info_up,new OnTopPosCallback(46),new CircleLightShape())
//                .addHighLight(R.id.id_btn_amazing,R.view_float_layout.info_up,new OnBottomPosCallback(46),new CircleLightShape());
//        mHightLight.show();
    }
