package com.dream.lmy.mydream.common.guideview.interfaces;
...
public interface HighLightInterface {
    ...
    public static interface OnShowCallback {
         ...
         */
        void onShow(HighLightView hightLightView);
    }
    ...
    public static interface OnNextCallback {
         ...
         */
        void onNext(HighLightView hightLightView, View targetView, View tipView);
    }
